...
global.baseUrl = 'https://www.saucedemo.com/';
...
program
    ...
    .option('--visual [type]', 'run the visual test on applitools')
    .parse(process.argv);
...
global.isVisual = program.opts().visual !== undefined;
...
global.browserHeadless = program.opts().headless !== undefined;
