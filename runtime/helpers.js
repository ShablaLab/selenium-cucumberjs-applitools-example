...
module.exports = {
    ...
    waitForElementDoesNotExist: async function (elementSelector) {
        await driver.wait(until.elementIsNotVisible(driver.findElement(elementSelector)));
    },
    /**
    ...
    */
    ...
    wait: async function (waitInseconds) {
        await driver.sleep(waitInseconds * 1000);
    },
    /**
